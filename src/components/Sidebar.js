...
export default function Sidebar({setSidebarStatus,sidebarStatus}) {
    return (
        <div className='sidebar-container' onClick={()=>setSidebarStatus(!sidebarStatus)}>
            <div className='sidebar-panel animated fadeInLeftBig' >
                ...
                <ul className='sidebar-links-container'>
                    ...
                    <li className='sidebar-list'><NavLink to='/courses'><a href='/courses'className='sidebar-links'><i class="fab fa-discourse"></i>&nbsp;&nbsp;&nbsp;&nbsp;Courses</a></NavLink></li>
